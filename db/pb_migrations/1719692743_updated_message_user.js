...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("i7je9rzo")

  // remove
  collection.schema.removeField("t6gtvcl1")

  // remove
  collection.schema.removeField("fssuqv7o")

  // remove
  collection.schema.removeField("aw3nrdlp")
