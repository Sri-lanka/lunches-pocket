...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("xz6pfwq6")

  // remove
  collection.schema.removeField("l9zngmgv")

  // remove
  collection.schema.removeField("noyjon5c")

  // remove
  collection.schema.removeField("zr8rfwz0")
