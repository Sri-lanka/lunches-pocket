...
migrate((db) => {
  ...
  // remove
  collection.schema.removeField("avwowdn4")

  // remove
  collection.schema.removeField("vvxslst1")

  // remove
  collection.schema.removeField("eli9zg9m")

  // remove
  collection.schema.removeField("qh6hg5hw")

  // remove
  collection.schema.removeField("fyqjhuza")
